...
window.insertTemplate = function(template) {
  if (window.easyMDEEditorInstance && window.easyMDEEditorInstance.editor && window.easyMDEEditorInstance.editor.codemirror) {
...
window.insertTemplateWithRetry = function(template) {
  ...
  const currentContent = window.easyMDEEditorInstance ?
    (window.easyMDEEditorInstance.editor ? window.easyMDEEditorInstance.editor.value() : '') : '';
